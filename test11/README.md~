...
Followers will run in PODs running under a service, called svcslave.

When a follower starts, it will "connect" in the svcleader and will "hear" for updates. Like shared registers, maybe.
